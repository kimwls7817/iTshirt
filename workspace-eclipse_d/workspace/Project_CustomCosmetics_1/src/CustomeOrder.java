...
public class CustomeOrder {
	...
	public static void main(String[] args) {
        ...
        while (!start) {
            System.out.println("");
            System.out.println("1. 회원 등록 밎 로그인");
            ...
            switch (cho) {
                ...
                case 3:
                    // 3. 주문 완료
                    start = true;
                    System.out.println("주문이 최종 완료되었습니다. 좋은 하루 되세요~");
                    break;
                default:
	...
	private static void UserTest(Scanner sc) {
        ...
        do {
            ...
            switch (menu) {
                ...
                default:
                    System.out.println(" ");
                    System.out.println("회원이 아니시거나 로그인이 되어있지 않은 상태에서는 구매하실 수 없습니다.");
                    System.out.println(" ");
                    break;
            }
        } while (cnd);
        System.out.println("회원가입 및 로그인이 완벽하게 완료되었습니다!");
    }

	private static void OrderTest(Scanner sc) {
		// 필드로 Bright, Color, Texture, Moisture
				...
				System.out.println("--------------------------------------");
				System.out.println(" ");
				System.out.println("주문하신 상품은 {{" + b + " " + c + " " + m + " "  + t +"}}타입의 제품입니다."); 
				System.out.println(" ");
				System.out.println("--------------------------------------");
				System.out.println(" ");
