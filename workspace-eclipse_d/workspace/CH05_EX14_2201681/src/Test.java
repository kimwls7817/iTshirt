...
public class Test {
	public static void main(String[] args) {
		...
		System.out.println(str1.lastIndexOf('a', 8)); //9
		System.out.println(str1.indexOf("Java")); //6
		System.out.println(str1.lastIndexOf("Java")); //6
		System.out.println(str1.indexOf("하세요")); //2
		System.out.println(str1.lastIndexOf("하세요")); //2
		System.out.println(str1.indexOf("Bye")); //2
		System.out.println(str1.lastIndexOf("고맙습니다.")); //2
